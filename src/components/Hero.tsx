...
const Hero = () => {
  return <section id="home" className="min-h-screen flex items-center justify-center pt-20 px-4 relative" style={{
    ...
    backgroundAttachment: 'fixed'
      ...
      <div className="container mx-auto text-center relative z-10">
        <img src="/logo.png" alt="MF Farias Terraplanagem - Logo" className="h-64 w-auto mx-auto mb-8 animate-fade-in brightness-0 invert" />
